const menu = [
  ...
  function filterItems(category) {
    ...
    if (category === 'all') {
      ...
      filteredItems = menu.filter(item => item.category.toLowerCase() === 'starters');
    } else if (category === 'mains') {
      filteredItems = menu.filter(item => item.category.toLowerCase() === 'mains');
    } else if (category === 'desserts') {
      filteredItems = menu.filter(item => item.category.toLowerCase() === 'desserts');
    } else if (category === 'beverages') {
      filteredItems = menu.filter(item => item.category.toLowerCase() === 'beverages');
    }
...
// Function to search menu items based on input
function searchItems() {
  const searchTerm = document.getElementById('search-input').value.toLowerCase();
  const searchedId = menu.filter(item => item.title.toLowerCase().includes(searchTerm));
  renderFilteredItems(searchedId);
}
...
searchBar.addEventListener('change', searchItems);
